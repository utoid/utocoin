...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["ucrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7cldym2", "ucrt1qfqeppuvj0ww98r6qghmdkj70tv8qpchel76qm7"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'ucrt1qtmp74ayg7p24uslctssvjm06q5phz4yrwm2tq4', # m/0'/0'/0
            'ucrt1q8vprchan07gzagd5e6v9wd7azyucksq2wlve97', # m/0'/0'/1
            'ucrt1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjfzdlv9', # m/0'/0'/2
            'ucrt1qau64272ymawq26t90md6an0ps99qkrseuqfexk', # m/0'/0'/3
            'ucrt1qsg97266hrh6cpmutqen8s4s962aryy776xa2mk', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'ucrt1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqfykev6') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'ucrt1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lns8fpa0y') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'ucrt1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqsx0ztc') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'ucrt1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjussjqf89') # Derived at m/84'/1'/0'/2
        ...
        genesis_block_hash = "704f2df3527ca59f901ef8bc683e08d44a59e34965450a115d90cbd46cc09928"
