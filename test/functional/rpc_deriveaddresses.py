...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "ucrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferrej0m7d"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["ucrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqaj8f7a", "ucrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2jne0we"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "ucrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqaj8f7a", "ucrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2jne0we"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [["ucrt1q7c8mdmdktrzs8xgpjmqw90tjn65j5a3y6g8cz2", "ucrt1qs6n37uzu0v0qfzf0r0csm0dwa7prc0v5567thk"], ["ucrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqaj8f7a", "ucrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2jne0we"]])
        ...
        assert_equal(self.nodes[0].deriveaddresses(descsum_create("wpkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/*)"), [2147483647, 2147483647]), ["ucrt1qtzs23vgzpreks5gtygwxf8tv5rldxvvsvwnw93"])
