...
class PSBTTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        self.num_nodes = 3
        self.extra_args = [
            ["-walletrbf=1", "-addresstype=bech32", "-changetype=bech32", "-txindex=1"], #TODO: Remove address type restrictions once taproot has psbt extensions
    ...
    def run_test(self):
        ...
        # ignore because adjust MAX_MONEY
