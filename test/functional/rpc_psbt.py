...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # NOTE: utocoin relaxes MoneyRange to `nValue >= 0` (no MAX_MONEY upper
        # bound — see src/consensus/amount.h), so the upstream test PSBT with a
        # value > 21,000,000 BTC is no longer treated as invalid. The
        # equivalent Bitcoin Core assertion ("Input 0 has invalid value") is
        ...
        # NOTE: same MoneyRange relaxation as above — utocoin doesn't reject
        # output amounts above MAX_MONEY, so this assertion is skipped.
