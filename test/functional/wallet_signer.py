...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "ucrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th60p8253")
        ...
        assert_equal(address4, "ucrt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msk937g0")
        ...
        assert_equal(address_fail, "ucrt1ql7zg7ukh3dwr25ex2zn9jse926f27xy269xycz")
