...
# Names retained for compatibility; values use the utocoin regtest bech32 hrp "ucrt".
ADDRESS_BCRT1_UNSPENDABLE = 'ucrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqj6ghv0'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(ucrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqj6ghv0)#cjswe32w'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'ucrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqn9fk0f'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'ucrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqs62fw7q')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("uto" if main else "ucrt", version, program)
