...
PUBKEY_ADDRESS = 68
SCRIPT_ADDRESS = 130
PUBKEY_ADDRESS_TESTNET4 = 222
SCRIPT_ADDRESS_TESTNET4 = 207
PUBKEY_ADDRESS_REGTEST = 111
SCRIPT_ADDRESS_REGTEST = 196
PRIVKEY = 196
PRIVKEY_TESTNET4 = 240
PRIVKEY_REGTEST = 239
...
templates = [
  ...
  ((PRIVKEY_TESTNET4,),       32, (),   (True,  'testnet4', False, None), (),           ()),
  ((PRIVKEY_TESTNET4,),       32, (1,), (True,  'testnet4', True,  None), (),           ()),
...
bech32_templates = [
  ...
  ('uto',   0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('uto',   0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('uto',   1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('uto',   2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tu',    0, 20, (False, 'testnet4', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tu',    0, 32, (False, 'testnet4', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tu',    1, 32, (False, 'testnet4', None, True), Encoding.BECH32M, p2tr_prefix),
  ('tu',    3, 16, (False, 'testnet4', None, True), Encoding.BECH32M, (OP_3, 16)),
  ('ucrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ucrt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ucrt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('ucrt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tu',   17, 32, Encoding.BECH32M, False, False, False),
  ('ucrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('uto',  15, 41, Encoding.BECH32M, False, False, False),
  ('tu',    0, 16, Encoding.BECH32,  False, False, False),
  ('ucrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('uto',   0, 16, Encoding.BECH32,  True,  False, False),
  ('tu',    0, 32, Encoding.BECH32,  False, True,  False),
  ('ucrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('uto',   0, 20, Encoding.BECH32M, False, False, False),
  ('tu',    0, 32, Encoding.BECH32M, False, False, False),
  ('ucrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('uto',   1, 32, Encoding.BECH32,  False, False, False),
  ('tu',    2, 16, Encoding.BECH32,  False, False, False),
  ('ucrt', 16, 20, Encoding.BECH32,  False, False, False),
]
