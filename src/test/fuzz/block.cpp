...
FUZZ_TARGET(block, .init = initialize_block)
{
    ...
    const bool valid_incl_pow_and_merkle = CheckBlockContextFree(block, validation_state_pow_and_merkle, consensus_params, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_pow = CheckBlockContextFree(block, validation_state_pow, consensus_params, /* fCheckMerkleRoot= */ false);
    ...
    const bool valid_incl_merkle = CheckBlockContextFree(block, validation_state_merkle, consensus_params, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_none = CheckBlockContextFree(block, validation_state_none, consensus_params, /* fCheckMerkleRoot= */ false);
