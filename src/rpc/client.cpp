...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendmany", 8, "fee_rate"},
    { "sendmany", 9, "verbose" },
    { "sendmanyex", 1, "amounts" },
    { "sendmanyex", 2, "minconf" },
    { "sendmanyex", 4, "subtractfeefrom" },
    { "sendmanyex", 5 , "replaceable" },
    { "sendmanyex", 6 , "conf_target" },
    { "sendmanyex", 8, "fee_rate"},
    { "sendmanyex", 9, "verbose" },
