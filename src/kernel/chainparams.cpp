...
{
    static constexpr uint256 hashGenesisBlock = uint256{"2be5d74003871900dd786760e42a03760526d9362332df4ed18b1ffd4a548455"};
    static constexpr uint256 hashMerkleRoot = uint256{"d5284bf000899b9b0b5dc6a8c0b1c67a9ed764071ddeec62fa86713d40c6719f"};
public:
    CBlock Create() override
    {
...
protected:
    void PatchConsensusParams()
    {
        ...
        consensus.randomx_genesis_key = "bitcoin/946065/000000000000000000003a4522741baed3efed5f150c66235ea80a37787f65e1";
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        genesis = CreateGenesisBlock(1598918400, 308163, 0x1e0377ae, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"b5ae0e805b5e54bef10fac99f7513908be6112daa6c968ac393e3e44c267dc3b"});
        assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
