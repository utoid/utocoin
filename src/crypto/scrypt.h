...
static const int SCRYPT_SCRATCHPAD_32K_SIZE = 4194304 + 63;

void scrypt_1024_1_1_256(const char *input, char *output);
void scrypt_1024_1_1_256_sp_generic(const char *input, char *output, char *scratchpad);
void scrypt_32k_1_1_256(const char *input, char *output);
void scrypt_32k_1_1_256_sp_generic(const char *input, char *output, char *scratchpad);
...
#define scrypt_32k_1_1_256_sp(input, output, scratchpad) scrypt_32k_1_1_256_sp_sse2((input), (output), (scratchpad))
#else
#define scrypt_1024_1_1_256_sp(input, output, scratchpad) scrypt_1024_1_1_256_sp_detected((input), (output), (scratchpad))
#define scrypt_32k_1_1_256_sp(input, output, scratchpad) scrypt_32k_1_1_256_sp_detected((input), (output), (scratchpad))
#endif
...
void scrypt_32k_1_1_256_sp_sse2(const char *input, char *output, char *scratchpad);
extern void (*scrypt_32k_1_1_256_sp_detected)(const char *input, char *output, char *scratchpad);
#else
#define scrypt_1024_1_1_256_sp(input, output, scratchpad) scrypt_1024_1_1_256_sp_generic((input), (output), (scratchpad))
#define scrypt_32k_1_1_256_sp(input, output, scratchpad) scrypt_32k_1_1_256_sp_generic((input), (output), (scratchpad))
#endif
